...
while True:
    # Game setup
    num_sonar_devices = int(input('How many sonar devices would you like: '))
    sonarDevices = num_sonar_devices
    theBoard = getNewBoard()
    num_treasure_chests = int(input('How many treasure chests would you like: '))
    theChests = getRandomChests(num_treasure_chests)
    drawBoard(theBoard)
    previousMoves = []
